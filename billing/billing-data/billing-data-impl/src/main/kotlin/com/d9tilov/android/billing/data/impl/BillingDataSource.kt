...
class BillingDataSource @Inject constructor(context: Context) :
        ...
        when (responseCode) {
            BillingClient.BillingResponseCode.OK -> {
                ...
                if (productDetailsList.isEmpty()) {
                    Timber.tag(TAG)
                        .d("onProductDetailsResponse: Found null or empty ProductDetails. Check to see if the Products you requested are correctly published in the Google Play Console.")
                } else {
    ...
    override fun buySku(
        ...
        if (currentPurchases.isEmpty()) {
            val billingParams: BillingFlowParams.Builder? = offerToken?.let {
