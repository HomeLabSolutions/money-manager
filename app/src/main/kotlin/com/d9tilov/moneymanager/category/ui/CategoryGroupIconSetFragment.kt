...
import com.d9tilov.moneymanager.category.ui.recycler.CategoryGroupIconSetAdapter
import com.d9tilov.moneymanager.category.ui.vm.CategoryGroupSetViewModel
import com.d9tilov.moneymanager.databinding.FragmentGroupCategoryIconSetBinding
...
class CategoryGroupIconSetFragment :
    ...
    private val adapter: CategoryGroupIconSetAdapter = CategoryGroupIconSetAdapter(
        listOf(
            CategoryGroupItem(CategoryGroup.HOUSING, R.string.category_group_housing),
            CategoryGroupItem(CategoryGroup.TRANSPORT, R.string.category_group_transportation),
            CategoryGroupItem(CategoryGroup.FOOD, R.string.category_group_food),
            CategoryGroupItem(CategoryGroup.UTILITIES, R.string.category_group_utilities),
            CategoryGroupItem(CategoryGroup.INSURANCE, R.string.category_group_insurance),
            CategoryGroupItem(CategoryGroup.MEDICAL, R.string.category_group_medical),
            CategoryGroupItem(CategoryGroup.SPORT, R.string.category_group_sport),
            CategoryGroupItem(CategoryGroup.INVESTING, R.string.category_group_investing),
            CategoryGroupItem(CategoryGroup.RECREATION, R.string.category_group_recreation),
            CategoryGroupItem(CategoryGroup.PERSONAL, R.string.category_group_personal),
            CategoryGroupItem(CategoryGroup.OTHERS, R.string.category_group_others)
        )
