...
class RegularTransactionInteractorImpl(
    ...
    override suspend fun insert(regularTransactionData: RegularTransaction) {
        ...
        val usdSumValue = currencyInteractor.toUsd(regularTransactionData.sum, currency)
    ...
    override suspend fun update(regularTransactionData: RegularTransaction) {
        val usdSumValue = currencyInteractor.toUsd(regularTransactionData.sum, regularTransactionData.currencyCode)
