...
public abstract class Hilt_SettingsBillingIntroFragment<N extends BaseNavigator, VB extends ViewBinding> extends BaseFragment<N, VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SettingsBillingIntroFragment_GeneratedInjector) this.generatedComponent()).injectSettingsBillingIntroFragment(UnsafeCasts.<SettingsBillingIntroFragment>unsafeCast(this));
    }
  }
