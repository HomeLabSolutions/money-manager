...
include(":category:category-data:impl")
include(":category:category-data:contract")
include(":category:category-domain:contract")
include(":category:category-domain:category-domain-model")
include(":category:category-domain:impl")
include(":category:ui")
