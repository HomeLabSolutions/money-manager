...
import com.d9tilov.android.regular.transaction.ui.diff.RegularTransactionDiffUtil
import com.d9tilov.android.regular_transaction_ui.R
import com.d9tilov.android.regular_transaction_ui.databinding.ItemRegularTransactionBinding
    ...
    class RegularTransactionViewHolder(private val viewBinding: ItemRegularTransactionBinding) :
        ...
        fun bind(regularTransaction: RegularTransaction) {
            viewBinding.run {
                ...
                val drawable = let2(regularTransaction.category.icon, regularTransaction.category.color) { icon, color ->
