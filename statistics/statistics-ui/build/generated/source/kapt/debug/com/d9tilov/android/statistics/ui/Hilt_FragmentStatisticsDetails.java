...
public abstract class Hilt_FragmentStatisticsDetails<N extends BaseNavigator, VB extends ViewBinding> extends BaseFragment<N, VB> implements GeneratedComponentManagerHolder {
  ...
  Hilt_FragmentStatisticsDetails(
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FragmentStatisticsDetails_GeneratedInjector) this.generatedComponent()).injectFragmentStatisticsDetails(UnsafeCasts.<FragmentStatisticsDetails>unsafeCast(this));
    }
  }
