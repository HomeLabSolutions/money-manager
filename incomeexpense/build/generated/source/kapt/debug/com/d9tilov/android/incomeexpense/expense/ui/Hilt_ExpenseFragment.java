...
public abstract class Hilt_ExpenseFragment<N extends BaseIncomeExpenseNavigator, VB extends ViewBinding> extends BaseIncomeExpenseFragment<N, VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ExpenseFragment_GeneratedInjector) this.generatedComponent()).injectExpenseFragment(UnsafeCasts.<ExpenseFragment>unsafeCast(this));
    }
  }
