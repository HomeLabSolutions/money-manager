...
public abstract class Hilt_IncomeExpenseFragment<N extends BaseNavigator, VB extends ViewBinding> extends BaseFragment<N, VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((IncomeExpenseFragment_GeneratedInjector) this.generatedComponent()).injectIncomeExpenseFragment(UnsafeCasts.<IncomeExpenseFragment>unsafeCast(this));
    }
  }
