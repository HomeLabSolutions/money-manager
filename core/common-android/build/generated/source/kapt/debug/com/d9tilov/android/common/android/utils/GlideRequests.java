...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.d9tilov.android.common.android.utils.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.d9tilov.android.common.android.utils.GlideOptions().apply(toSet));
    }
  }
}
