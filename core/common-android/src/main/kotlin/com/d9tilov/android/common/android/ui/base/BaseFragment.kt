...
import com.d9tilov.android.common.android.ui.base.BaseViewModel.Companion.DEFAULT_MESSAGE_ID
...
abstract class BaseFragment<N : BaseNavigator, VB : ViewBinding>(
    ...
    protected fun showSnackBar(text: String, gravityCenter: Boolean = false) {
        baseActivity?.let {
            val backgroundTint = requireContext().getColorFromAttr(androidx.appcompat.R.attr.colorPrimary)
